...
~ <span style="color:lightblue">1 + x1</span> + <span style="color:lightblue">spline(x1, bs="bs", df=4) + spline(x2, bs="bs",df=4)</span> + <span style="color:darkred">d1(x3) + d2(x5)</span>
